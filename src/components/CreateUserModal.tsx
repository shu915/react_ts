              ...
              <div className="flex gap-4">
                ...
                <div className="flex gap-4 items-center w-1/2">
                  ...
                  <input
                    ...
                    {...register("taskCode", {
                      required:
                        role === "student" ? "課題番号は必須です" : false,
                    })}
                  />
                  {errors.taskCode && (
                    <p className="text-red-500">{errors.taskCode.message}</p>
                  )}
                </div>
              </div>
              <div className="flex gap-4 items-center">
                ...
                />
                {errors.studyLangs && (
                  <p className="text-red-500">{errors.studyLangs.message}</p>
                )}
              </div>
              <div className="flex gap-4 items-center">
                ...
                <input
                  ...
                  {...register("score", {
                    required:
                      role === "student" ? "ハピネススコアは必須です" : false,
                  })}
                />
                {errors.score && (
            ...
            <>
              <div className="flex gap-4 items-center">
                ...
                <input
                  ...
                  {...register("experienceDays", {
                    required: role === "mentor" ? "経験日数は必須です" : false,
                  })}
                />
              ...
              <div className="flex gap-4 items-center">
                ...
                <input
                  ...
                  id="useLangs"
                  {...register("useLangs", {
                    required: role === "mentor" ? "使用言語は必須です" : false,
                  })}
                />
                {errors.useLangs && (
                  <p className="text-red-500">{errors.useLangs.message}</p>
                )}
              </div>
